...
ActiveRecord::Schema.define(version: 2019_11_14_003343) do
  ...
  create_table "res_images", force: :cascade do |t|
    t.string "image"
    t.integer "restaurant_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["restaurant_id"], name: "index_res_images_on_restaurant_id"
  end
